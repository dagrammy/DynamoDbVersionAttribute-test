        ...
        try {
            ...
            client.createTable(tableRequest ->
                tableRequest.tableName(TABLE_NAME)
                    .keySchema(keySchema -> keySchema.attributeName("name").keyType(KeyType.HASH))
                    .attributeDefinitions(attrDef -> attrDef.attributeName("name").attributeType(ScalarAttributeType.S))
